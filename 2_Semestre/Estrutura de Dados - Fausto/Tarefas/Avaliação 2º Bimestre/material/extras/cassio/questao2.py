"""
    1) COPIE para este arquivo o código da classe DoublyLinkedList.
    
    2) Com base no método __str__(), implemente um outro método que
       permita exibir a lista em ordem inversa (do último ao primeiro
       elemento).
"""
...
lista.insert_back('Joao')
lista.insert_back('Maria')

lista.insert_front('Jose')
lista.insert_front('Ronaldo')
lista.insert_front('Getulio')

print(lista)

# Tentei, tentei, tentei, mas não consegui chegar em lugar algum. Acabei deixando em branco.