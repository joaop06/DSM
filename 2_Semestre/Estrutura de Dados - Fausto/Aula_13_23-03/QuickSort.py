...
def quick_sort(lista, ini=0, fim=None):
    ''' Quando não soubermos o valor da variável "fim",
        vamos atrivuir a ela a última posição da lista'''
    if fim is None: fim = len(lista)-1

    ''' Para que o algoritmo travvalhe, é necessário que a faixa delemitada pelas variáveis "ini" e "fim" tenha, pelo menos, dois elementos.
    ...
    for pos in range(ini, fim):
        ...
        if lista[pos] < lista[pivot]:
            ...
            ''' Se os valores das variáveis "div" e "pos" forem diferentes entre si e o elemento da posição "pos" for menor que o elemento
