"""
    ...
    direcionados (digrafos). Tem várias aplicações, como a 
    representação de redes de computadores, mapas e caminhos e
    redes sociais.
"""
class Graph:
    ...
    """
        ...
        ter arestas incidentes, ou seja, seu grau deve ser 0,
        nem ser referenciado por outros vértices)
    """
