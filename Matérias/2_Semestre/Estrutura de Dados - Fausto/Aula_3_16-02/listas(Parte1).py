...
print('''OPERAÇÕES SOBRE LISTAS

1) Percurso: Significa percorrer a lista do primeiro até o último elemento, fazendo aldo com cada um deles.\nNo caso a seguir, vamos exibir cado um dos elementos separadamente usnado print().''')
for v in valores:
    print(v)
...
''' 2)'''
print('2) Inserção de um novo elemento no fim da lista\n')
valores.append(45)
print(valores)
...
''' 3)'''
print('''3) Inserindo um novo elemento em uma posição ESPECÍFICA: insert()
...
''' 4)'''
print('4) Acessando um valor em uma posição específica\n')
...
''' 5)'''
print('5) Subistituindo valores existentes\n')
print("Antes: ", valores)
